...
function createHighlightButtons(){
	...
	new ButtonGroup({
		...
		},
		{
			...
			turnOnCallback: makeHighlighter( cube.hasColor( ERNO.WHITE ))
		}
	])
}
...
function createLabelButtons(){
	...
	new ButtonGroup({
		...
		},
		{
			...
			turnOnCallback:  function(){ cube.hideLogo(); cube.showIds(); setMark() },
...
function createOtherButtons(){
	...
	new ButtonGroup({
		...
		turnOnCallback: function(){
			...
			document.getElementById( 'infoToggle' ).src = 'media/buttons/close.png'// bad form man!
		},
		turnOffCallback: function(){

			document.getElementById( 'info' ).classList.remove( 'show' )
			document.getElementById( 'infoToggle' ).src = 'media/buttons/info.png'// bad form man!
		}
	})
	infoToggle.turnOff()
